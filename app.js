/**
 * GoopiApp - Core Logic (Tokyo Midnight Pro Edition v33.9)
 */
console.log("🚀 GOOPIAPP VERSION 33.9 LOADED");
...
function showInfoPopup(page) {
    ...
    popupBody.innerHTML = `
        <div class="popup-content">
            ...
            ${featuredImg ? `<img src="${featuredImg}" style="display: block; margin: 0 auto 15px; max-width: 50%; max-height: 120px; width: auto; height: auto; object-fit: contain; border-radius: 12px; box-shadow: 0 5px 15px rgba(0,0,0,0.4);">` : ''}
